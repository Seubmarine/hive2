...
intro_text = """
        Durant une nuit festive à Port-Royal, vous avez gagnez aux jeux une carte
        maritime au fin fond d'une taverne, si alcolisée que tout le monde est
        saoul avant même d'avoir commandé son premier verre de rhum. En effet
        votre adversaire de table n'était autre que "Pimflick jambe de bois",
        le dernier membre vivant de l'équipage de "Barbe noire" le célèbre
        pirate qui écuma les mers des Caraïbes. Pimflick n'a pas eu d'autre
        choix que de vous donner sa carte pour honorer son pari perdu. Mauvais
        joueur qu'il est, c'est surtout votre mousquet sur son front qu'il l'a
        convaincu. "Va au diable, pauvre fou !", ce sont ses dernières paroles
        que vous avez entendu en quittant la taverne.

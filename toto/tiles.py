...
class JungleTile(MapTile):
    ...
    def intro_text(self, player):
        ...
        Toutes ces piqures vous font perdre 2 points de vie...
        """
...
class OldPirateTile(PirateTile):
    ...
    def __init__(self, x, y):
        ...
        De toute manière, c'est définfitivement terminé pour lui désormais...
        """
...
class EnemyTile(MapTile):
    def __init__(self, x, y):
        ...
        de s'entouler autour de vous pour vous étouffer.
        """
            self.dead_text = """
        L'anaconda git au sol completement flasque.
        """
        elif r < 0.95:
...
class FindTalisamanTile(LootTile):
    ...
    def intro_text(self, player):
        ...
        """
            ...
            return """
        Votre oeil est attirer par quelque chose de brillant au sol.
...
class FindSwordTile(LootTile):
    ...
    def intro_text(self, player):
        ...
        """
            ...
            return """
        Plantez dans un squelette vous trouvez un sabre qui étrangement n'est
        absoluement pas rouillé.
        Vous le prenez en main : léger et vif comme l'éclair, tranchant comme un
        rasoir. Vous décidez de le garder apparement il manque  personne.
        """
...
class RiverTile(MapTile):
    ...
    def modify_player(self, player):
        ...
        if r < 0.50:
            print("""
        Vous vous dépêchez de nagez avant qu'il ne vous arrive malheur.
            """)
        elif r < 0.80:
            print("""
...
class LivingDeadTile(EnemyTile):
    ...
    def __init__(self, x, y):
        ...
        self.alive_text = """
        Une horde de pirate morts-vivants vous assaille. Vous comprenez que
        Barbe Noire n'avait pas choisit cette île au hasard pour protéger son
